...
function api_manager(roles, access_manager){
...
/*
var api_manager = new api_manager(api_manger.http(server, "/api"), api_manager.json_rpc());
...
api_manager.prototype.roles = _.r("_roles");
