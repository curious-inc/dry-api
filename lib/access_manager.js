...
access_manager.prototype.context_prepper = function(){
    ...
    return(function(next, context, req_hash){
        if(req_hash && req_hash.tags && req_hash.tags.access_token){
            self.get(_.s(req_hash.tags.access_token), function(err, record, expired){
