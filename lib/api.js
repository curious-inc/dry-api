...
api.prototype.context_prepper = _.hook.event_function("context");
api.prototype.prepare_context = function(context, callback){
    this.bite("context", [context], callback, this.context_timeout);
};
...
api.prototype.call = function(method_name, context, hash, callback){
    ...
    self.access_manager().get(context.access_token, _.plumb(function(security_context){
        ...
        self.prepare_context(context, _.plumb(function(context){

            self.find_method(method_name, context, _.plumb(function(method){

                // assertions throw errors
                if(self.testing){ return method.apply(context, hash, callback);  }
