...
/*
set this ptr in rpc functions to context object, have hook of functions that add context. this.user for instance, this.session, etc.
...
api.prototype.call = function(method_name, context, args, callback){
    ...
    self.bite("context", [context], _.plumb(function(){
        ...
        self.validate_expectations(method, args, function(err){
            ...
            // don't add the callback until after you validate
            args.unshift(callback); 
            
            // assertions throw errors
            if(self.testing){ return method.apply(context, args);  }

            try{ return method.apply(context, args); }
