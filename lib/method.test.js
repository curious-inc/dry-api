...
test("call", function(done){
    ...
    m.call({ foo: "foo" }, message_in, function(err, result){
        eq(null, err);
        eq(result, expected);
        done();
    });
...
test("no params, no support", function(done){
    ...
    m.call(null, { third: '3', first: '1', second: '2' }, function(err, result){
...
test("malformed_call params", function(done){
    ...
    m.call(null, { params: "string" }, function(err, result){
...
test("use request params", function(done){
    ...
    m.call(null, { third: '3', first: '1', second: '2', params: ['third', 'first', 'second'] }, function(err, result){
        eq(err, null);
        eq(result, expected);
        done();
    });
...
test("use named params", function(done){
    ...
    m.call(null, { third: 3, first: '1', not_an_arg: 'invalid' }, function(err, result){
        eq(err, null);
        eq(result, expected);
        done();
    });
...
test("override named params", function(done){
    ...
    m.call(null, { third: 3, first: '1', not_an_arg: 'invalid', params: ["third", "second", "first"] }, function(err, result){
        eq(err, null);
        eq(result, expected);
        done();
    });
...
test("use request params, with undefined and unused", function(done){
    ...
    m.call(null, { one: '1', three: 3, invalid: 'invalid', params: ['one', '', 'three'] }, function(err, result){
        eq(err, null);
        eq(result, expected);
        done();
    });
...
test("results to error hash ", function(){
    ...
    m.call(null, { id: 15, "1": "one", params: ["1"] }, function(err, result){
...
test("throws wrapped", function(){
    ...
    m.call(null, { id: 15, "1": "one", params: ["1"] }, function(err, result){
        ...
        eq(err.message, "this was thrown.");
        eq(err.thrown, true);
        eq(result, expected);
    });
});
...
test("results to hash with hash", function(){
    ...
    m.call(null, message_in, function(err, result){
        eq(err, null);
        eq(result, expected);
    });
});
...
test("prepare_arguments error", function(done){
    ...
    m.call(null, { params:[] }, function(err, result){
...
test("expects good", function(done){
    ...
    m.call(null, args_to_message([1, 2]), function(err, result){
        eq(err, null);
...
test("expects better", function(done){
    ...
    m.call(null, args_to_message([1, ""]), function(err, result){
        eq(err, null);
...
test("expector good", function(done){
    ...
    m.call(null, args_to_message([1, 1]), function(err, result){
        ok(!err);
...
test("expector bad", function(done){
    ...
    m.call(null, args_to_message(['special', 1]), function(err, result){
        eq(_.code(err), "invalid_arguments");
        done();
    });
});
...
test("expector bad now good", function(done){
    ...
    m.call(null, args_to_message(['special', 2]), function(err, result){
        eq(err, null);
...
test("expector test error", function(done){
    ...
    m.call(null, args_to_message(['bad_parameter', 2]), function(err, result){
